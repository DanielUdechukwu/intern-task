...
export default function Navigation() {
    ...
    return (
        <nav className="flex items-center w-[95%] mx-auto justify-between my-[.4rem]">
            <div>
                <Image
                    src="/icons/logo.svg"
                    width={24}
            ...
            <ul className="flex group items-center bg-[#f5f5f5] gap-1 px-2 rounded-2xl backdrop-blur-2xl py-[.4rem]">
                {navItems.map((items, index) => (
                    <li
                        key={items.id}
                        onClick={() => setActiveIndex(index)}
                        className={`h-10 w-13 flex items-center justify-center rounded-xl cursor-pointer transition ease-in-out duration-100 ${
                            activeIndex === index
                                ? "bg-white shadow-sm"
                                : "hover:bg-[#e5e5e5]"
                        }`}
